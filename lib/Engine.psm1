# Constants for strings states in file type modules
$global:STRING_STATE_NOT_TRANSLATED = 0
$global:STRING_STATE_TRANSLATED     = 1
$global:STRING_STATE_APPROVED       = 2

# Constants for file comparison results in Update-GameData.ps1
$global:COMPARISON_FILES_SAME        = 0
$global:COMPARISON_FILES_DIFFERENT   = 1
$global:COMPARISON_ONLY_FILE1_EXISTS = 2
$global:COMPARISON_ONLY_FILE2_EXISTS = 3
$global:COMPARISON_FILES_DONT_EXIST  = 4

$global:VAR_START_BYTE        = [byte] 0x02
$global:UNIX_NL_BYTE          = [byte] 0x0A
$global:COLUMN_SEPARATOR      = '<tab>'
$global:COLUMN_SEPARATOR_BYTE = [System.Text.Encoding]::UTF8.GetBytes($COLUMN_SEPARATOR)


# Yes, I know they are not technically constants but I treat them as such.
# PS extension in VS Code still can't recognize variables/constants if they
# were created via New-Variable cmdlet, that's why they're actually regular
# global variables.
